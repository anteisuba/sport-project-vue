    ...
    <div class="login_container">
        ...
        <div class="login_box">
            ...
            <div class="avatar_box">
                <img src="../assets/mei.png" alt/>
            </div>
            <!-- 表单区域 -->
            <el-form ref="loginFormRef" :rules="loginRules" :model="loginForm" class="login_form" label-width="0"> 
                <!-- 用户名 -->
                <el-form-item prop="username">
                    <el-input v-model="loginForm.username"  prefix-icon="iconfont icon-gongzuotai" ></el-input>
                </el-form-item> 
                <!-- 密码 -->
                <el-form-item prop="password">
                    <el-input v-model="loginForm.password"  prefix-icon="iconfont icon-a-Group789" type="password"></el-input>
                </el-form-item> 
                <!-- 按钮 -->
    ...
    data() {
        return {
            ...
            loginRules:{
                //校验用户名
                username:[
                    { required: true, message: '用户名为必填项', trigger: 'blur' }, //必填项验证,失去焦点
                    { min: 5, max: 12, message: '长度在 5 ~ 12 个字符', trigger: 'blur' } //长度验证
                ],
                //校验密码
                password:[
                    { required: true, message: '用户密码为必填项', trigger: 'blur' }, //必填项验证,失去焦点
